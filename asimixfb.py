#!usr/bin/python
#FACEBOOK ASIMIX HACKER can crack into Facebook Database 100% without Interruption By Facebook Firewall !
#This program is for educational purposes only.
#Don't attack people facebook accounts it's illegal ! 
#If you want to crack into someone's account, you must have the permission of the user. 
#ASIMIX Hacker is not responsible.
...
GHT = '''
        +=========================================+
        |.........Facebook ASIMIX Hacker..........|
        +-----------------------------------------+
        |#Author: Asif Pallimalil                 |
        |#Contact: www.facebook.com/asipallimalil |
        |#Date: 8/9/2016                          |
