#!/usr/bin/perl
#
# Tool: AISMIX Facebook Cracker
# Author:Asif Pallimalil
# Contact: asimix@asimix.in
# Code date: 30 April 2017
# 
...
system('clear');
print "\n+++ AISMIX Facebook Cracker\n";
print "+++ Coded by Asif Pallimalil\n";
print "+++ www.fb.com/asipallimalil\n\n";
